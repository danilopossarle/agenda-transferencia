...
public class TransferenciaBuilder implements Builder<Transferencia> {
    ...
    public static TransferenciaBuilder umaTransferencia() {
        ...
        builder.comContaDestino("12345-6").comContaOrigem("65432-1").comDataCadastro(dataCadastro).comDataTransferencia(dataTransferencia)
                .comTaxa(ONE).comValor(TEN).comTipo(A);
