...
/**
 * Fábrica de calculadoras para os diferentes tipos de transferências aceitos na aplicação.
 * Essa fábrica será um bean do spring que poderá ser injetado onde for necessário.
 * 
...
public class CalculadoraTaxaFactory {
	 ...
	 */
	@Autowired
	public CalculadoraTaxaFactory(CalculadoraTaxaA calculadoraTaxaA, CalculadoraTaxaB calculadoraTaxaB, 
			CalculadoraTaxaC calculadoraTaxaC, CalculadoraTaxaD calculadoraTaxaD) {
		this.calculadorasMap.put(A, calculadoraTaxaA);
		this.calculadorasMap.put(B, calculadoraTaxaA);
		this.calculadorasMap.put(C, calculadoraTaxaA);
		this.calculadorasMap.put(D, calculadoraTaxaA);
	}
