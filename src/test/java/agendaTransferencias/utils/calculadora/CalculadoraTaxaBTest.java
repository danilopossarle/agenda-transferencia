...
public class CalculadoraTaxaBTest {
	...
	public void calculaTaxaIntervaloMenorQue30() {
		...
		Assert.assertEquals(TEN, this.calculadoraTaxaB.calcularTaxa(this.transferencia));
	}
	...
	public void calculaTaxaIntervaloMaiorQue30() {
		...
		Assert.assertEquals(new BigDecimal("8"), this.calculadoraTaxaB.calcularTaxa(this.transferencia));
	}
